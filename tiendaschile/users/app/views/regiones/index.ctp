<div class="regiones index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $region['Region']['id_region']; ?>&nbsp;</td>
		<td><?php echo $region['Region']['nom_region']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $region['Region']['id_region'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $region['Region']['id_region'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $region['Region']['id_region']), null, sprintf(__('Are you sure you want to delete # %s?', true), $region['Region']['id_region'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
